...
INSERT INTO "new_Job" ("authorId", "categoryId", "createdAt", "description", "id", "location", "published", "salary", "title") SELECT "authorId", "categoryId", "createdAt", "description", "id", "location", "published", "salary", "title" FROM "Job";
DROP TABLE "Job";
